 ...
 */
final class Version20240407214341 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE famille ADD COLUMN norder INTEGER DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_9474526C7294869C ON comment (article_id)');
        $this->addSql('CREATE INDEX IDX_9474526CA76ED395 ON comment (user_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__famille AS SELECT id, famille, cover_image, updated_at FROM famille');
        $this->addSql('DROP TABLE famille');
        $this->addSql('CREATE TABLE famille (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, famille VARCHAR(75) NOT NULL, cover_image VARCHAR(255) DEFAULT NULL, updated_at DATETIME DEFAULT NULL)');
        $this->addSql('INSERT INTO famille (id, famille, cover_image, updated_at) SELECT id, famille, cover_image, updated_at FROM __temp__famille');
        $this->addSql('DROP TABLE __temp__famille');
        $this->addSql('DROP INDEX IDX_C53D045F7294869C');
        $this->addSql('DROP INDEX IDX_C53D045F3B69A9AF');
        $this->addSql('CREATE TEMPORARY TABLE __temp__image AS SELECT id, article_id, variant_id, caption, updated_at, url FROM image');
        $this->addSql('DROP TABLE image');
