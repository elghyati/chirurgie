 ...
 */
final class Version20200817094414 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__article AS SELECT id, sous_famille_id, reference, designation, description, cover_image, price, updated_at, slug FROM article');
        $this->addSql('DROP TABLE article');
        $this->addSql('CREATE TABLE article (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, sous_famille_id INTEGER NOT NULL, reference VARCHAR(10) NOT NULL COLLATE BINARY, designation VARCHAR(100) NOT NULL COLLATE BINARY, cover_image VARCHAR(255) DEFAULT NULL COLLATE BINARY, price NUMERIC(12, 2) NOT NULL, updated_at DATETIME DEFAULT NULL, slug VARCHAR(255) NOT NULL COLLATE BINARY, description CLOB DEFAULT NULL, CONSTRAINT FK_23A0E6671DF2E6E FOREIGN KEY (sous_famille_id) REFERENCES sous_famille (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO article (id, sous_famille_id, reference, designation, description, cover_image, price, updated_at, slug) SELECT id, sous_famille_id, reference, designation, description, cover_image, price, updated_at, slug FROM __temp__article');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_23A0E6671DF2E6E');
        $this->addSql('CREATE TEMPORARY TABLE __temp__article AS SELECT id, sous_famille_id, reference, designation, description, cover_image, slug, price, updated_at FROM article');
        $this->addSql('DROP TABLE article');
        $this->addSql('CREATE TABLE article (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, sous_famille_id INTEGER NOT NULL, reference VARCHAR(10) NOT NULL, designation VARCHAR(100) NOT NULL, cover_image VARCHAR(255) DEFAULT NULL, slug VARCHAR(255) NOT NULL, price NUMERIC(12, 2) NOT NULL, updated_at DATETIME DEFAULT NULL, description CLOB NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO article (id, sous_famille_id, reference, designation, description, cover_image, slug, price, updated_at) SELECT id, sous_famille_id, reference, designation, description, cover_image, slug, price, updated_at FROM __temp__article');
        $this->addSql('DROP TABLE __temp__article');
        $this->addSql('CREATE INDEX IDX_23A0E6671DF2E6E ON article (sous_famille_id)');
        $this->addSql('DROP INDEX IDX_EFE84AD1354DE8F3');
        $this->addSql('DROP INDEX IDX_EFE84AD12CA8B87C');
