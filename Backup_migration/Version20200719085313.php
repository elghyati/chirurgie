 ...
 */
final class Version20200719085313 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE image');
        $this->addSql('CREATE TABLE image (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, article_id INTEGER DEFAULT NULL, url VARCHAR(255) DEFAULT NULL, caption VARCHAR(255) DEFAULT NULL, updated_at DATETIME DEFAULT NULL)');
