 ...
 */
final class Version20240325142815 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__middle_slide AS SELECT id, display, image, updated_at FROM middle_slide');
        $this->addSql('DROP TABLE middle_slide');
        $this->addSql('CREATE TABLE middle_slide (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, display BOOLEAN NOT NULL, updated_at DATETIME NOT NULL, image VARCHAR(255) DEFAULT NULL)');
        $this->addSql('INSERT INTO middle_slide (id, display, image, updated_at) SELECT id, display, image, updated_at FROM __temp__middle_slide');
        $this->addSql('DROP TABLE __temp__middle_slide');
        ...
        $this->addSql('ALTER TABLE promotion ADD COLUMN name VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE promotion ADD COLUMN motif VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE promotion ADD COLUMN percentage VARCHAR(5) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_C53D045F7294869C ON image (article_id)');
        $this->addSql('CREATE INDEX IDX_C53D045F3B69A9AF ON image (variant_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__middle_slide AS SELECT id, image, display, updated_at FROM middle_slide');
        $this->addSql('DROP TABLE middle_slide');
        $this->addSql('CREATE TABLE middle_slide (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, display BOOLEAN NOT NULL, updated_at DATETIME NOT NULL, image VARCHAR(255) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO middle_slide (id, image, display, updated_at) SELECT id, image, display, updated_at FROM __temp__middle_slide');
        $this->addSql('DROP TABLE __temp__middle_slide');
        $this->addSql('DROP INDEX IDX_F52993989395C3F3');
        $this->addSql('DROP INDEX IDX_F5299398896DBBDE');
        $this->addSql('DROP INDEX IDX_F52993986BF700BD');
        ...
        $this->addSql('CREATE INDEX IDX_ED896F467294869C ON order_detail (article_id)');
        $this->addSql('CREATE INDEX IDX_ED896F462B1C2395 ON order_detail (related_order_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__promotion AS SELECT id, display, image, updated_at FROM promotion');
        $this->addSql('DROP TABLE promotion');
        $this->addSql('CREATE TABLE promotion (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, display BOOLEAN NOT NULL, image VARCHAR(255) DEFAULT NULL, updated_at DATETIME NOT NULL)');
        $this->addSql('INSERT INTO promotion (id, display, image, updated_at) SELECT id, display, image, updated_at FROM __temp__promotion');
