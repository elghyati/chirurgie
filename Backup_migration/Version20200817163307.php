 ...
 */
final class Version20200817163307 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__article AS SELECT id, sous_famille_id, reference, designation, cover_image, price, updated_at, slug, description FROM article');
        $this->addSql('DROP TABLE article');
        $this->addSql('CREATE TABLE article (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, sous_famille_id INTEGER NOT NULL, reference VARCHAR(10) NOT NULL COLLATE BINARY, designation VARCHAR(100) NOT NULL COLLATE BINARY, cover_image VARCHAR(255) DEFAULT NULL COLLATE BINARY, price NUMERIC(12, 2) NOT NULL, updated_at DATETIME DEFAULT NULL, slug VARCHAR(255) NOT NULL COLLATE BINARY, description CLOB DEFAULT NULL COLLATE BINARY, CONSTRAINT FK_23A0E6671DF2E6E FOREIGN KEY (sous_famille_id) REFERENCES sous_famille (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO article (id, sous_famille_id, reference, designation, cover_image, price, updated_at, slug, description) SELECT id, sous_famille_id, reference, designation, cover_image, price, updated_at, slug, description FROM __temp__article');
