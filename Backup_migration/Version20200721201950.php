 ...
 */
final class Version20200721201950 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE famille ADD COLUMN updated_at DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_9474526C7294869C ON comment (article_id)');
        $this->addSql('CREATE INDEX IDX_9474526CF675F31B ON comment (author_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__famille AS SELECT id, famille, cover_image FROM famille');
        $this->addSql('DROP TABLE famille');
        $this->addSql('CREATE TABLE famille (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, famille VARCHAR(75) NOT NULL, cover_image VARCHAR(255) DEFAULT NULL)');
        $this->addSql('INSERT INTO famille (id, famille, cover_image) SELECT id, famille, cover_image FROM __temp__famille');
